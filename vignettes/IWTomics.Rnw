...
\textsf{IWTomics} package is available at bioconductor.org and can be installed, typing the following commands in the R console (an internet connection is needed)
